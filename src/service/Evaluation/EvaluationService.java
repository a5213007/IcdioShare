...
public class EvaluationService implements IBaseService{
	...
	public List<Map<String, Object>> findByKeyAndValue(String key, String value,String type, int page, Long id){
		try {
			if(permissionsService.hasPerssions("Evaluation", id) || permissionsService.hasPerssions("Evaluation_display", id)){
				List<Map<String, Object>> list = evaluationDao.findByKeyAndValue(key, value,type, page,null);
				List<Map<String, Object>> list1 = evaluationDao.findByKeyAndValuePage(key, value,type, page,null);
