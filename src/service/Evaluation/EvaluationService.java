...
public class EvaluationService implements IBaseService{
	...
	public List<Map<String, Object>> findByKeyAndValue(String key, String value, int page){
		try {
			List<Map<String, Object>> list = evaluationDao.findByKeyAndValue(key, value, page);
			List<Map<String, Object>> list1 = evaluationDao.findByKeyAndValuePage(key, value, page);
